...
parser.add_argument('--txt_seq_len', type=int, default=60,help='max len of input texts tokens')
parser.add_argument('--prefix_txt_len', type=int, default=20,help='the commmon length of prefix text for training')
parser.add_argument('--target_txt_len', type=int, default=60,help='max len of target text')
parser.add_argument('--max_trunc_txt_len', type=int, default=15,help='max real prefix len without padding')
